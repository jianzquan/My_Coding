...
class Processor(object):
    ...
    def __init__(self, args, data, model) -> None:
        ...
        if args.optim_type=='SGD':   self.optimizer = optim.SGD(param, lr=args.lr, weight_decay=0)
        if args.optim_type=='AdamW': self.optimizer = optim.AdamW(param, lr=args.lr, weight_decay=0)
